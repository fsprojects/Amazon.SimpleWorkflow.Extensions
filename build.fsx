...
let project = "Amazon.SimpleWorkflow.Extensions"

// Short summary of the project
// (used as description in AssemblyInfo and as a short summary for NuGet package)
let summary = "Provides an intuitive API for modelling workflows against SWF"
...
let tags = "aws amazon cloud swf simpleworkflow fsharp f# csharp c#"

// File system information 
// (<solutionFile>.sln is built during the building process)
let solutionFile  = "SWF.Extensions.sln"
...
let gitName = "Amazon.SimpleWorkflow.Extensions"
...
Target "AssemblyInfo" (fun _ ->
  let fileName = "SWF.Extensions/SWF.Extensions.Core/AssemblyInfo.fs"
...
Target "Build" (fun _ ->
    files [ "SWF.Extensions/SWF.Extensions.Core/SWF.Extensions.Core.fsproj"
            "SWF.Extensions/SWF.Extensions.CoreCs/SWF.Extensions.CoreCs.csproj" ]
        ...
        { p with   
            ...
            Dependencies = 
                        [ "AWSSDK",  GetPackageVersion "packages" "AWSSDK"
                          ...
                          "ServiceStack.Text", GetPackageVersion "packages" "ServiceStack.Text" ] })
